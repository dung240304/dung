            ...
            <?php foreach ($arr1 as $key) { ?>
              <div class="item">
                <a href="chi-tiet.php?id=<?php echo $key['id_blog'];  ?>">
                  <img style=" height: 350px;"  src="image/1.jpg<?php echo $key['image']; ?>" alt="<?php echo $key['image']; ?>" title="<?php echo $key['title']; ?>" class="w-100" />
                </a>
                <h2>
          ...
          <?php foreach ($arr2 as $key) { ?>
            <div class="row section-article">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 section-image-article">
                <a href="chi-tiet.php?id=<?php echo $key['id_blog'];  ?>">
                  <img  style=" height: 150px; "src="admin/image/1.jpg<?php echo $key['image']; ?>" alt="<?php echo $key['image']; ?>" title="<?php echo $key['title']; ?>" class="w-100" />
                </a>
              </div>
